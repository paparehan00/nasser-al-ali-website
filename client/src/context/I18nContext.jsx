...
const T = {
  en: {
    ...
    "fleet.lede":          "A modern, owner-operated fleet of heavy plant and equipment supporting civil, MEP and site-logistics operations across Qatar and the wider GCC.",
    ...
    "about.body":          "Established in Qatar in 2005, Nasser Al Ali Enterprises is a full-service construction and engineering group delivering turnkey project execution across the built environment. We self-perform civil, structural, mechanical, electrical (MEP) and infrastructure works for landmark developments - including the Doha Metro, the National Museum of Qatar and Lusail City. With a 5,000+ skilled workforce, our own plant-and-equipment fleet and joint ventures with leading international contractors, we deliver complex programmes on schedule, within budget and to strict quality and HSE standards.",
    ...
    "companyProfile.body":     "Nasser Al Ali Enterprises was established in Doha in 2005 and has grown into one of the country's most trusted contracting and engineering groups. We supply technical manpower, heavy plant and equipment, civil construction and integrated MEP services to some of Qatar's largest infrastructure and building projects. Every team deploys with a clear method statement, a site-specific risk assessment and strict HSE compliance, so work is done safely, correctly and on programme - from a single fit-out task to a full turnkey development. Download our company profile below for our history, our capabilities and our delivery record.",

    "missionVisionPage.overline": "MISSION & VISION",
    "missionVisionPage.title":    "What We Promise, Where We're Going",
    "missionVisionPage.intro":   "Since 2005, Nasser Al Ali Enterprises has delivered complex engineering, construction and infrastructure programmes across Qatar. Our mission and vision are the engineering standards behind every decision - from detailed design coordination and procurement to on-site construction management, quality assurance and final handover.",
    "missionVisionPage.missionHeading": "Our Mission",
    "missionVisionPage.missionBody": "Our mission is to deliver engineered solutions that perform - every project on specification, on programme and on budget.\n\nWe deploy a 5,000+ technical workforce, an owner-operated plant-and-equipment fleet and integrated MEP capability under a single accountable framework. Through method statements, site-specific risk assessments and daily QA/QC controls, we manage quality and HSE at the point of work - not after it. We hold to schedule, because programme certainty is what lets our clients plan with confidence and commit to their own delivery dates.\n\nWe treat every client as a long-term engineering partner. We listen, we challenge, and we are precise about what we can deliver and by when. A promise kept on a complex build is a genuine competitive advantage, and it is how we have retained major contractors and developers for two decades.",
    "missionVisionPage.visionHeading": "Our Vision",
    "missionVisionPage.visionBody": "Our vision is to be Qatar's most trusted engineering and construction partner - the first name a developer or contractor calls when the brief is demanding.\n\nAs the country's built environment advances, we are growing alongside it: expanding into value engineering, digital delivery and sustainable construction methods, while investing in our people, plant and technical systems. Growth is only meaningful if it raises the standard. Every larger project, new capability and technology adoption must make us safer, more reliable and more precise - not simply bigger.\n\nWe are building an integrated group that sets the benchmark for engineering quality in the region - delivering landmark projects safely, on programme and to specification, one project at a time.",

    "leadership.overline": "ORGANIZATION",
    "leadership.title":    "Our Leadership",
    "leadership.lede":     "The engineering, commercial and operations leadership delivering Nasser Al Ali Enterprises' projects every day.",
    ...
    "footer.slogan":       "Two decades of engineering Qatar's skyline.",
    "footer.tag":          "Engineered safely, delivered on schedule, at scale.",
    ...
    "gallery.lede":            "Explore the contractors, landmark projects and engineering milestones that define our delivery record.",
    "gallery.clients":         "Our Clients",
    "gallery.clientsOverline": "TRUSTED PARTNERS",
    "gallery.clientsLede":     "43+ leading contractors and developers across Qatar and the wider GCC.",
    "gallery.projects":        "Projects",
    "gallery.projectsOverline":"FEATURED PROJECTS",
    "gallery.projectsLede":    "Landmark engineering and construction projects that define Qatar's built environment.",
    "gallery.awardsCSR":       "Awards & CSR",
    "gallery.awardsOverline":  "RECOGNITION & COMMUNITY",
    "gallery.awardsLede":      "Awards and recognitions that reflect our engineering standards and our commitment to sustainable delivery.",
    "gallery.loading":         "Loading…",

    "sisterConcerns.overline":   "OUR GROUP",
    "sisterConcerns.title":      "Sister Concerns",
    "sisterConcerns.lede":       "An integrated group of sister companies extending our engineering, construction and support capabilities across related sectors.",
    "sisterConcerns.comingSoon":"Full profiles for our sister companies are being finalised and will be published here shortly. For details in the meantime, contact our group coordination team.",
    ...
    "footer.blurb":        "Adding engineering value to your operations through certified technical manpower, heavy plant and equipment, and integrated civil and MEP contracting - built on two decades of trust in Qatar.",
