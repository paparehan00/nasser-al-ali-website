...
export default function Terms() {
  ...
  return (
    <LegalPage crumb="Terms of Use" title="Terms of Use" updated="[DATE]">
      <div className="callout"><strong>Legal review required.</strong> These Terms are a working draft. They should be reviewed by qualified legal counsel in Qatar before being relied upon as a binding legal document.</div>
      ...
      <h2>2. About us</h2>
      <p>Nasser Al Ali Enterprises is a Qatar-registered heavy-construction and contracting company. Commercial Registration: <span className="placeholder-token">[CR number - to be provided]</span>. Office: Salwa Road, Building-155, Zone 43, Doha, State of Qatar. Postal: P.O. Box 13115, Doha, Qatar.</p>
      ...
      <p>Our AI-powered chat assistant is provided as an <strong>informational aid</strong> only. Its responses are generated by a third-party language model (Google Gemini) using our approved knowledge base. The assistant may occasionally produce incomplete or incorrect answers. It is not a substitute for professional engineering, legal, financial, or contractual advice. Do not share sensitive personal information via the chat assistant.</p>
      ...
      <p>The Site links to third-party platforms (WhatsApp, Facebook, Google Maps, Calendly, Google Gemini). Your use of those services is governed by their own terms.</p>
