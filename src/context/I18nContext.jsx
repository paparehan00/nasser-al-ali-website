...
const T = {
  en: {
    ...
    "certs.lede":          "Nasser Al Ali Enterprises operates under three internationally recognised management-system standards, independently audited and certified by United Registrar of Systems (URS) - UKAS and IAF accredited. All three certificates are current through January 2029. Click any certificate to view it full size.",
    "certs.iso9001.title": "Quality Management System",
    "certs.iso9001.desc":  "Certifies that our quality management processes consistently meet customer, regulatory and statutory requirements across every project we deliver.",
    "certs.iso14001.title":"Environmental Management System",
    "certs.iso14001.desc": "Certifies that we identify, monitor and reduce the environmental impact of our operations - from site waste and emissions to resource use across our fleet and facilities.",
    "certs.iso45001.title":"Occupational Health & Safety Management System",
    "certs.iso45001.desc": "Certifies that we operate a workplace-safety framework aligned to the world's leading H&S standard - covering hazard control, incident reporting and continuous worker-welfare improvement. Replaces the earlier OHSAS 18001.",
    "certs.issuer":        "Issued by URS (United Registrar of Systems) - UKAS + IAF accredited",
    "certs.certNo":        "Certificate no.",
  ...
  ar: {
    ...
    "certs.lede":          "تعمل ناصر العلي للمقاولات وفق ثلاثة معايير دولية لأنظمة الإدارة، مُدقَّقة ومُعتمَدة بشكل مستقل من قِبل United Registrar of Systems (URS) - المعتمَدة من UKAS و IAF. جميع الشهادات الثلاث سارية حتى يناير 2029. انقر على أي شهادة لعرضها بالحجم الكامل.",
    "certs.iso9001.title": "نظام إدارة الجودة",
    "certs.iso9001.desc":  "تُثبت أن عملياتنا لإدارة الجودة تلبّي باستمرار متطلبات العملاء والمتطلبات القانونية والتنظيمية في كل مشروع نُنفذه.",
    "certs.iso14001.title":"نظام الإدارة البيئية",
    "certs.iso14001.desc": "تُثبت أننا نُحدّد ونُراقب ونُقلّل الأثر البيئي لعملياتنا - من نفايات المواقع والانبعاثات إلى استخدام الموارد عبر أسطولنا ومنشآتنا.",
    "certs.iso45001.title":"نظام إدارة الصحة والسلامة المهنية",
    "certs.iso45001.desc": "تُثبت تطبيقنا لإطار عمل السلامة المهنية وفق أعلى المعايير العالمية - يشمل التحكم بالمخاطر والإبلاغ عن الحوادث والتحسين المستمر لرفاهية العمال. تحل محل معيار OHSAS 18001 السابق.",
    "certs.issuer":        "صادرة عن URS (United Registrar of Systems) - معتمَدة من UKAS و IAF",
    "certs.certNo":        "رقم الشهادة",
    "certs.validUntil":    "سارية حتى",
